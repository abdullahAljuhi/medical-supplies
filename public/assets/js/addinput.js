$(document).ready(function(){
    ...
    var fieldHTML_flie ='<div class=" mt-3 "><input type="file" id="name" placeholder="قم بكتابة اسم العلاج مثل بندول او فوار..." class=" col-12 col-md-8 mb-2 form-control-custome"name="images[]" autofocus><input type="text" id="name" placeholder="حدد الكمية" class="col-md-3 col-12 form-control-custome mb-2 me-1 py-2" name="quantity[]" autofocus><a href="javascript:void(0);" class="remove_button_file col-1 pe-2"><i class="bi fs-3 bi-dash-circle-fill text-danger"></i></a></div>'; //New input field html
    var x = 1; //Initial field counter is 1
    //Once add button is clicked
