...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ secure_asse('assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ secure_asse('assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ secure_asse('assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
    <link href="{{ secure_asse('assets/vendor/quill/quill.snow.css') }}" rel="stylesheet">
    <link href="{{ secure_asse('assets/vendor/quill/quill.bubble.css') }}" rel="stylesheet">
    <link href="{{ secure_asse('assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
    <link href="{{ secure_asse('assets/vendor/simple-datatables/style.css') }}" rel="stylesheet">
    ...
    <link href="{{ secure_asse('assets/css/style.css') }}" rel="stylesheet">
    <!-- Costume CSS Files -->
