...
<header id="header" class="header d-flex align-items-center position-relative">
                        ...
                        @isset($orders)
                            ...
                            @if($count)
                                ...
                                <li class="dropdown-footer">
                                    <a class="text-nowrap" href="{{ route('orders') }}">عرض جميع الطلبات</a>
                                </li>
                            @else
    ...
    <div
        class="position-absolute top-100 bg-white w-100 order-lg-1 order-md-2 align-self-center navbar-collapse flex-fill d-lg-none w-100 justify-content-lg-between collapse p-3"
