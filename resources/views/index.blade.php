                    ...
                    <div class="container">
                        <div class="row p-5">
                            <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                                <img class="img-fluid top-slider w-100 h-auto p-5"
                                     src="{{asset('img/md/prescription.png') }}" alt="">
                            </div>
    ...
    <section class="bg-light">
        <div class="container pb-5 p-xl-5 p-0">
            ...
            <div class="row d-flex justify-content-center align-items-center mt-5">
                <a href="{{ route('morePharmacy') }}" class="btn btn-outline-primary py-2 w-auto px-5 rounded fs-5">الاطلاع
