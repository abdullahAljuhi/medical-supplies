    ...
    <div class="container pb-5">
        ...
        <div class="row  col-md-4-d">
            <div class="col-12 col-md-4 mb-4">
                <div class="card  shadow  mb-5 bg-body  d-flex justify-content-center align-items-center"
                    style=" padding: 0 0 1rem 0 ; overflow: hidden;border-radius: 1rem;">
                    <div class="row card-img-top w-100 mb-2 h-100 ">
                        <img src="{{asset('img/phramacy1.png ') }}" class="card-img-top w-100  card-pharmacy    p-0"
                            alt="...">
                    </div>
                    <!-- strat info  -->
                    <div class="card-body">
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card  shadow  mb-5 bg-body  d-flex justify-content-center align-items-center"
                    style=" padding: 0 0 1rem 0 ; overflow: hidden;border-radius: 1rem;">
                    <div class="row card-img-top w-100 mb-2 h-100 ">
                        <img src="{{asset('img/phramacy6.png ') }}" class="card-img-top w-100  card-pharmacy  p-0"
                            alt="...">
                    </div>
                    <!-- strat info  -->
                    <div class="card-body">
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <a href="#" class="btn btn-outline-primary py-2 w-25 rounded fs-5   ">الاطلاع اكثر <i
