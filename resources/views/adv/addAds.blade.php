...
<section class="section profile min-vh-100 overflow-hidden">
    ...
    <div class="wrapper">
        <div class="view_main container shadow ">
            <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('save.adv') }}"
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <input id="strat_date" type="date" class="form-control @error('strat_date') is-invalid @enderror"
                        name="start_date" value="{{ old('strat_date') }}" required autocomplete="strat_date" autofocus>
