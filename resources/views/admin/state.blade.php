                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="name" type="text"
                                        class="form-control form-control @error('name') is-invalid @enderror" id="state"
                                        value="">
                                    @error('name')
            ...
            <table class="table table-hover datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('edit-state', $governorate->id) }}"><button
                                    class="btn   btn-outline-success px-4">تعديل</button></td>
                        <td>

                            @if( $governorate->is_active)
                            <a href="{{ route('active.state', $governorate->id) }}"
