    ...
    <div class="col-xl-12 col-md-12 col-12 mb-md-0 mb-4">
        <div class="card invoice-preview-card">
            ...
            <div class="card-body">
                ...
                $order->pharmacy->address[0]->city->name ??''}} - {{ $order->pharmacy->address[0]->street ??''}}</span>
                        </div>
                        <div class="mb-2">
                ...
                <table class="table border-top m-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{-- evt.target --}}
                                @if ( Auth::user()->type == 0 && $order->status== 2 && $product['yield'] != 1 )
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-outline-primary">تأكيد
                                    التسليم</a>
                                <!-- Modal -->
