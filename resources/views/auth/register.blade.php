                            ...
                            <ul class="nav nav-tabs w-100 p-0 mt-2 nav-order p-1 rounded overflow border">
                                ...
                                <li class="nav-item  w-50 fs-5  d-flex justify-content-center align-items-center">
                                    <button class="nav-link active w-100" data-bs-toggle="tab" data-bs-toggle="tab"
                                            data-bs-target="#user-register">انشاء حساب مستخدم
                                    </button>
                                </li>

                                <li class="nav-item  w-50 fs-5  d-flex justify-content-center align-items-center">
                                    <button class="nav-link w-100" data-bs-toggle="tab"
                                            data-bs-target="#pharmacy-register">انشاء حساب صيدلية
                                    </button>
                                </li>
                            ...
                            <div class="tab-content p-3">
                                ...
                                <div class="tab-pane fade" id="pharmacy-register">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="col-12">
                                            <label for="yourName" class="form-label">كلمة المرور</label>
                                            <input type="text" name="name" class="form-control" id="yourName" required>
                                            <div class="invalid-feedback">يرجى اسم الصيدلية</div>
                                        </div>

                                        <div class="col-12">
                                            <label for="yourName" class="form-label">تأكيد كلمة المرور</label>
                                            <input type="text" name="name" class="form-control" id="yourName" required>
                                            <div class="invalid-feedback">يرجى اسم الصيدلية</div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="tel" name="email" class="form-control" id="yourEmail"
                                                   required>
