                    ...
                    <div class="card-body p-2">
                        ...
                        <ul class="nav nav-tabs w-100 mt-2 nav-order p-2  shadow-sm rounded overflow border">
                            ...
                            <li class="nav-item  w-50 fs-5  d-flex justify-content-center align-items-center">
                                <button class="nav-link active w-100" data-bs-toggle="tab" data-bs-toggle="tab"
                                    data-bs-target="#user-register">انشاء حساب مستخدم</button>
                            </li>

                            <li class="nav-item  w-50 fs-5  d-flex justify-content-center align-items-center">
                                <button class="nav-link w-100" data-bs-toggle="tab"
                                    data-bs-target="#pharmacy-register">انشاء حساب صيدلية</button>
                            </li>
                        ...
                        <div class="tab-content p-3 pt-2">
                            ...
                            <div class="tab-pane fade" id="pharmacy-register">
                                ...
                                <input class="form-check-input" name="type" type="hidden" value="2">
                                <div class="col-12">
                                    <button class="btn btn-primary w-100" type="submit">أنشاء حساب</button>
                                </div>
                                <div class="col-12">
